...
========================================================
|icon| Stock Picking Package Preparation Line 10.0.1.0.4
========================================================


.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/stock-logistics-workflow/10.0/stock_picking_package_preparation_line/static/description/icon.png
...
|en| Delivery document line management
--------------------------------------
...
|it| Gestione righe documenti di trasporto
------------------------------------------

Modulo con funzionalità per le righe dei documenti di trasporto.
...
* |menu| Setting > Apps |right_do| Select **stock_picking_package_preparation_line** > Install
...
* |menu| Setting > Activate Developer mode
* |menu| Apps > Update Apps List
* |menu| Setting > Apps |right_do| Select **stock_picking_package_preparation_line** > Update
...
This module is part of stock-logistics-workflow project.
