...
===================================================
|icon| Stock Picking Package Preparation 10.0.1.0.2
===================================================


.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/stock-logistics-workflow/10.0/stock_picking_package_preparation/static/description/icon.png
...
|en| Delivery document management
---------------------------------
...
|it| Gestione documenti di trasporto
------------------------------------
...
* |menu| Setting > Apps |right_do| Select **stock_picking_package_preparation** > Install
...
* |menu| Setting > Activate Developer mode
* |menu| Apps > Update Apps List
* |menu| Setting > Apps |right_do| Select **stock_picking_package_preparation** > Update
